                        ...
                        <x-dropdown align="right" width="60">
                            <x-slot name="trigger">
                                <span class="inline-flex rounded-md">
                                    <button type="button" class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-green-100 bg-green-600 hover:text-white hover:bg-green-700 focus:outline-none focus:bg-green-700 active:bg-green-700 transition ease-in-out duration-150">
