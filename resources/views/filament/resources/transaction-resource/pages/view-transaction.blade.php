        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <div class="bg-white rounded-lg shadow p-4">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        <p class="text-sm font-medium text-gray-500">Bills Total</p>
                        <p class="text-2xl font-semibold text-red-600">
                            €{{ number_format($this->record->bills->sum('total_amount'), 2) }}
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-lg shadow p-4">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-semibold text-gray-900">
                            {{ $this->record->bills->where('status', 'Paid')->count() }}
                        </p>
                    </div>
                </div>
            </div>
                        ...
                        @else
                            @forelse($this->record->bills as $bill)
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                        {{ $bill->file->provider->name ?? $bill->file->providerBranch->name ?? 'N/A' }}
                                    </td>
