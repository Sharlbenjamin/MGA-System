    ...
    <x-filament::section>
        ...
        @if ($hasActiveFilter)
            <div class="mb-4 flex flex-wrap items-center justify-between gap-3 rounded-xl border border-primary-200 bg-primary-50 px-4 py-3 dark:border-primary-800 dark:bg-primary-950/40">
                ...
                <button
                    type="button"
                    class="rounded-lg bg-white px-3 py-1.5 text-sm font-medium text-primary-700 shadow-sm ring-1 ring-primary-200 hover:bg-primary-100 dark:bg-primary-900 dark:text-primary-100 dark:hover:bg-primary-800"
        ...
        <div class="flex flex-wrap items-center justify-between gap-4">
            <div>
                ...
                <div class="mt-1 text-xs text-gray-500 dark:text-gray-400">
                    Files where provider bills exceed the invoice total, or a bill was created after the invoice.
                </div>
            </div>
            <button
                type="button"
