    ...
    <x-filament::section>
        @php
            ...
            $issueChipClasses = [
                ...
                \App\Services\FileBillingIntegrityService::ISSUE_BILL_AFTER_INVOICE_SENT => 'border-info-200 bg-info-50 text-info-800 hover:bg-info-100 dark:border-info-800 dark:bg-info-950/40 dark:text-info-200 dark:hover:bg-info-950/60 [&_span:last-child]:bg-info-100 dark:[&_span:last-child]:bg-info-900',
            ];
