...
class Provider extends Model
{
    ...
    protected $fillable = ['country_id','status','type','name','payment_due','payment_method','needs_payment','comment','request_comment','gop_contact_id','operation_contact_id','financial_contact_id','phone','email','signed_contract_draft','assigned_user_id',];
