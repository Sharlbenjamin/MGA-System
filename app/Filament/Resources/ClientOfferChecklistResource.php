...
class ClientOfferChecklistResource extends Resource
{
    ...
    protected static ?string $navigationLabel = 'Client Offers';

    protected static ?string $modelLabel = 'Client offer';

    protected static ?string $pluralModelLabel = 'Client Offers';
