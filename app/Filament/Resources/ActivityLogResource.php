            ...
            ->filters([
                ...
                Tables\Filters\SelectFilter::make('subject_type')
                    ...
                    ->options([
                        ...
                        \App\Models\Gop::class => 'GOP',
                        \App\Models\Bill::class => 'Bill',
                        \App\Models\Comment::class => 'Comment',
                        \App\Models\MedicalReport::class => 'Medical Report',
                        \App\Models\Prescription::class => 'Prescription',
                        \App\Models\Appointment::class => 'Appointment',
                        \App\Models\Task::class => 'Task',
                        \App\Models\BankAccount::class => 'Bank Account',
                        \App\Models\Invoice::class => 'Invoice',
                        \App\Models\FileAssignment::class => 'Assignment',
                        \App\Models\ProviderBranch::class => 'Branch',
                        \App\Models\ProviderLead::class => 'Provider Lead',
