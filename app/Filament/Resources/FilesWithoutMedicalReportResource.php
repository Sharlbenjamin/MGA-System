...
class FilesWithoutMedicalReportResource extends Resource
{
    ...
    {
        return static::getModel()::whereDoesntHave('medicalReports')->count();
    }
    ...
    {
        return $table
            ->modifyQueryUsing(fn (Builder $query) => $query->whereDoesntHave('medicalReports'))
            ->columns([
    ...
    {
        return [
            'index' => Pages\ListFilesWithoutMedicalReports::route('/'),
        ];
    }
} 