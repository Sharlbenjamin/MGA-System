...
class FileStatsOverview extends BaseWidget
{
    ...
    protected function getStats(): array
    {
        ...
        return [
            ...
            Stat::make('Revenue', '€'.number_format($monthRevenue, 0))->description('Revenue this month')->color('success'),
            Stat::make('Expenses', '€'.number_format($monthExpenses, 0))->description('Expenses this month')->color('danger'),
            Stat::make('Profit', '€'.number_format($monthProfit, 0))->description('Profit this month')->color('info'),
